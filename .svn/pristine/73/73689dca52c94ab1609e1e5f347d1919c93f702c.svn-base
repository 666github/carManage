    ...
    public class ExcelHelper
    {
        ...
        public static MemoryStream Export(DataTable dtSource, string strHeaderText)
        {
            ...
            #region 右击文件 属性信息
            {
                ...
                si.Author = "jzht"; //填加xls文件作者信息
                si.ApplicationName = "加油记录"; //填加xls文件创建程序信息
                si.LastAuthor = "jzht"; //填加xls文件最后保存者信息
                si.Comments = "jzht"; //填加xls文件作者信息
                si.Title = "jzht"; //填加xls文件标题信息
                si.Subject = "jzht";//填加文件主题信息
