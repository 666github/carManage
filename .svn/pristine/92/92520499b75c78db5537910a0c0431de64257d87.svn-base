...
//		var holidayEnd=$("#holidayEnd").val();
		$.ajax({
			type:"get",
			url:"http://192.168.1.120:2238/handler/CarManage/HolidayUse/ViewHolidayCars.ashx",
			xhrFields: {withCredentials: true },
...
//立即指定	
		$(".nowAppoint").click(function(){
			...
			function nowappoint(){debugger
				$.ajax({
					type:"get",
					url:"http://192.168.1.120:2238/handler/CarManage/HolidayUse/AddHolidayUse.ashx",
					xhrFields: {withCredentials:true},
...
//取消指定
		$(".delAppoint").click(function(){
			...
			function delappoint(){
				$.ajax({
					type:"get",
					url:"http://192.168.1.120:2238/handler/CarManage/HolidayUse/RemoveHolidayUse.ashx",
					xhrFields: {withCredentials: true },
