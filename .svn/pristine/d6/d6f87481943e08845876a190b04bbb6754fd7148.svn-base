...
//		$(".loadingStatus").fadeIn();
//		$(".loadingStatus").fadeOut();
		$('.returnFrame').removeClass("hide").addClass("animated zoomIn");
		$('.returnFrame').siblings("div").addClass("hide");
	});
	$('.warningMessage ').click(function(){
//		$(".loadingStatus").fadeIn();
//		$(".loadingStatus").fadeOut();
		$('.breakRuleFrame').removeClass("hide").addClass("animated zoomIn");
...
function getAllMessage(){
	...
	$.ajax({
		type:"get",
		url:"http://192.168.1.111:2238/handler/Index/MessageRemind.ashx",
   		xhrFields: {
      		withCredentials: true
		},//data/driverMess.json
		data:{"status":status},
		dataType:"json",
