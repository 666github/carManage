...
//			+'<li class="warning_inf1"><p class="warning_inf11"><span>您正在违规用车，非发用车类型为</span><span class="warning_reson">'+warning[i].warning_inf1+'</span></p></li>'
//			+'<p class="warning_inf12"><span>这是您这个月违规用车第</span><span class="warning_times">'+warning[i].warning_inf2+'</span><span>次</span></p><span class="warning_time">'+warning[i].warning_inf31+'</span>'
//			+'</li></ul>')
//		}																				
//	})