$(function(){
	...
	function branchM(){
		$.ajax({
			type:"get",
			url:"http://192.168.1.120:2238/handler/DepartmentManage/View.ashx",
			xhrFields:{withCredentials:true},
			data:{from:0},
			dataType:"json",
			async:true,
...
//		}
	...
	$(".quitSure #sureadd").unbind("click").click(function(){
			...
			if(branchBm!=""){
					$.ajax({
					type:"get",
					url:"http://192.168.1.120:2238/handler/DepartmentManage/Add.ashx",
					xhrFields:{withCredentials:true},
	...
	function amendDel(){
		...
		$(".quitSure #sureamend").unbind("click").click(function(){
			...
			if(branchBm!=""){
					$.ajax({
					type:"get",
					url:"http://192.168.1.120:2238/handler/DepartmentManage/ChangeName.ashx",
					xhrFields:{withCredentials:true},
...
//			});	
			...
			function deletHtml(){debugger;
				$.ajax({
					type:"get",
					url:"http://192.168.1.120:2238/handler/DepartmentManage/Delete.ashx",
					xhrFields:{withCredentials:true},
