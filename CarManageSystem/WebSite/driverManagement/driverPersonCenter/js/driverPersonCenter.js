...
$(function(){
	$.get("/handler/GetCurrentUser.ashx",function(data){			
		if(data.state=="success"){
			...
			$("#oEmail").placeholder=data.myemail;
...
// 		}
	...
	$(".safePhone").click(function(){		
		if(safePhone){
			...
			$.get("/handler/PersonalCenter/ChangeSecurityInfo.ashx",{"value":phoneVal,"flag":1},function(data){				
				if(data.state=="success"){
