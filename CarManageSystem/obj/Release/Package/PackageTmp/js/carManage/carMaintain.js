	...
	function M1(maintInf){
		...
		for(var i=0;i<maintInf.length;i++){
			...
			$("#maintainNeed").append($('<ul class="maintInf"><li class="choice">'+
				'<li class="carImg"><img src="'+maintInf[i].carImg+'"/></li><li class="brand" id="brandM"><span class="firBrand">'+maintInf[i].brand+'</span><span class="maintReason" style="float:right;">'+maintInf[i].maintReason+'</span></li>'+
