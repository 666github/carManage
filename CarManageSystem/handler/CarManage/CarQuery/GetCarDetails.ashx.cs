            ...
            using (cmsdbEntities cms = new cmsdbEntities())
            {
                ...
                var car = cms.carinfo
                    ...
                    .Select(s => new
                    {
                        ...
                        mtStartDet = s.r.MaintenanceStartDate==null?"": s.r.MaintenanceStartDate.Value.ToShortDateString(),
                        mtEndDet = s.r.MaintenanceEndDate == null ? "" : s.r.MaintenanceEndDate.Value.ToShortDateString(),
                        mileDet = s.r.Mileage,
                        mtMile = s.r.MtMile,
                        mtMileOrdate  = s.r.MtMileOrDate,
                        ...
                        currentState = s.r.CarState == 0 && (s.r.HolodayStart <= now.Date && s.r.HolodayEnd > now.Date) ? 4 : (s.r.CarState == 0 && s.r.NeedMaintain == 1 ? 5 : s.r.CarState)
                ...
                var person = cms.carinfo
                    ...
                    .Select(i => new
                    {
                        ...
                        currUsed=i.b.b.UseCarTime.Value.ToShortDateString()+" "+i.b.b.UseCarTime.Value.ToShortTimeString(),
                        currBack=i.b.b.ExpectReturnTime.Value.ToShortDateString()+" "+ i.b.b.ExpectReturnTime.Value.ToShortTimeString(),
