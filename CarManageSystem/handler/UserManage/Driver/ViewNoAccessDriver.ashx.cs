...
{
    /// <summary>
    /// ViewNoAccessDriver 的摘要说明
    /// </summary>
    public class ViewNoAccessDriver : IHttpHandler,IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            using (cmsdbEntities cms = new cmsdbEntities())
            {
                ...
                var users = cms.user
                    .Where(s => s.ApplyRole == viewType&&s.ApplyState==2 &&(department==-1?true: s.Department == department))
